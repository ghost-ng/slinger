...
class TestSMBLib:
    ...
    def test_list_shares(self, mock_client):
        ...
        mock_shares = [
            {"shi1_netname": b"C$\x00", "shi1_type": 0x0, "shi1_remark": b"Default share\x00"},
            {"shi1_netname": b"ADMIN$\x00", "shi1_type": 0x0, "shi1_remark": b"Remote Admin\x00"},
            {"shi1_netname": b"IPC$\x00", "shi1_type": 0x3, "shi1_remark": b"Remote IPC\x00"},
        ]
